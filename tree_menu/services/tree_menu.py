...
class TreeMenu:
    ...
    def _query_to_family(self):
        ...
        def get_all_child_with_grandchild(item_id):
            ...
            for child_id in family[item_id]['child']:
                ...
                family[item_id]['all_child'].extend(get_all_child_with_grandchild(child_id))
    ...
    def _get_child(self, menu_item):
        ...
        for child_id in self.__family[menu_item]['child']:
            ...
            if self.__current in self.__family[child_id]['all_child'] or self.__current == child_id:
    ...
    def __render_by_tree(self, for_render_tree, first: bool = True):
        ...
        return self.list_menu_items_html.format(menu_items=list_menu_items, ul_class=ul_class)

    def render_menu(self):
        if self.__head is None:
            return f'Tree menu &lt;{self.menu_name}&gt; not fount'

        for_render_tree = self._free_for_render()
